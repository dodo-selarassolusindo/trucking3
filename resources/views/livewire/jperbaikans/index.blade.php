@section('title')
Trucking Apps v2 | Data Jenis Perbaikan
@endsection
...
<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="/jperbaikans/create" wire:navigate class="btn btn-md btn-success rounded shadow-sm border-0 mb-3">TAMBAH JENIS PERBAIKAN</a>
