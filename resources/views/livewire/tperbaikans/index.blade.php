@section('title')
Data Transaksi Perbaikan - Trucking Apps v2
@endsection
...
<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="/tperbaikans/create" wire:navigate class="btn btn-md btn-success rounded shadow-sm border-0 mb-3">ADD NEW TRANSAKSI PERBAIKAN</a>
